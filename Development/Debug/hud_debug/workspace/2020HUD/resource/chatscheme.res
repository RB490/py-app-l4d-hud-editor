...
Scheme
{
	...
	BaseSettings
	{
		...
		ScrollBarSlider.NobDragColor			"Blank"		// nob active drag color
	...
	Fonts
	{
		...
		// which font to use at different resolutions. yres is a range of vertical screen resolutions
		// position of 'basechat.res' -> 'ChatInputLine' is calculated from this font
		"Default"
		{
			"1"
			{
