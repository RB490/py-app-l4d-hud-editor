...
Scheme
{
	...
	BaseSettings
	{
		...
		Button.ArmedTextColor			"BrightRed"
		Button.ArmedBgColor				"LightGray"
		Button.DepressedTextColor		"BrightRed"
		...
		order.Bright					"Gray"		// the lit side of a control
		...
		Frame.ClientInsetX					"100"
		Frame.ClientInsetY					"100"
