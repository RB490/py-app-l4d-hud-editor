...
from game_v2.game_v2 import DirectoryMode, VideoSettingsModifier
...
class GameV2Commands:
    ...
    def execute(self, input_command):
        ...
        command_file = os.path.join(
            self.game.dir._get_main_dir(DirectoryMode.DEVELOPER), "cfg", "hud_editor_command.cfg"
        )
    ...
    def _get_reload_fonts_command(self):
        ...
        video_settings_modifier = VideoSettingsModifier(
            os.path.join(self.game.dir._get_main_dir(DirectoryMode.DEVELOPER), "cfg")
        )
